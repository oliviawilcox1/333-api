...
const startProducts = [
{
    ...
    name:  "The Body Wash" ,
    image:  "https://www.spacenk.com/on/demandware.static/-/Sites-spacenkmastercatalog/default/dw58f91b8d/products/NECESSAIRE/UK200033170_NECESSAIRE.jpg", 
    brand: "Necessaire",
    description: "The Body Wash is a cleansing, soft-foaming gel formulated with facial-grade ingredients including marula, meadowfoam, and cacay oils. It is naturally rich in vitamins A, C, and E and omegas 6 and 9, and it includes barrier-supporting niacinamide. Skin is left feeling soft and comfortable. Comes in different scents including fragrance-free, sandalwood, eucalyptus and bergamot. It is also formulated without sulfates or parabens, is vegan and cruelty free.",
    kbeauty: false,
    size: "8.4 oz/ 250 mL",
    price: 30.00,
    category: "Haircare",
    wheretobuy: "Sephora, Ulta",
    ingredienthighlights: "Niacinamide and Marula, Cacay and Meadowfoam Oil",
    ingredients: "Aqua/Water/Eau, Sodium Laurylglucosides Hydroxypropylsulfonate, Caprylyl/Capryl Glucoside, Disodium Cocoamphodiacetate, Glycerin, Sodium Chloride, Sodium Methyl Cocoyl Taurate, Niacinamide, Tocopherol, Saccharum Officinarum (Sugar Cane) Extract, Pyrus Malus (Apple) Fruit Extract, Citrus Aurantium Dulcis (Orange) Fruit Extract, Citrus Limon (Lemon) Fruit Extract, Camellia Sinensis Leaf Extract, Sclerocarya Birrea Seed Oil, Caryodendron Orinocense Seed Oil, Limnanthes Alba (Meadowfoam) Seed Oil, Caprylyl Glycol, Phenoxyethanol, Citric Acid, Chlorphenesin, Sodium Phytate.",
    target: "All Skin Types",
    instructions: "Apply all over body and massage for a rich foam then rinse.",
    type: "body wash",
}, {
    name:  "Skin [reserve blend]" ,
    image:  "https://lyko.com/globalassets/product-images/clean-reserve-skin-reserve-blend-edp-100ml-1079-141-0100_12.jpg?ref=753787&w=1200&h=2389&quality=75", 
    brand: "Clean Reserve",
    description: "Creamy Madagascar vanilla offers a soft and subtle sweetness to the cozy musk, creating the perfect everyday perfume. Skin is crafted with sustainable vanilla from Madagascar to support programs for reforestation, drinking water wells and medical facilities for the farming communities. Cruelty-free and Vegan.",
    kbeauty: false,
    size: "3.4 oz/ 101 mL",
    price: 98.00,
    category: "Fragrance",
    wheretobuy: "Sephora, Clean Beauty",
    ingredienthighlights: "Fresh Musk, Copaiba Oil, Salted Praline",
    ingredients: "Alcohol Denat., Fragrance, Water, Glycerin, Aloe Barbadensis Leaf Juice, Phenoxyethanol, Benzyl Salicylate, Citronellol, Limonene, Citral, Coumarin, Linalool, Benzyl Alcohol.",
    instructions: "Apply in the creases of your knees and elbows for a longer-lasting, stronger scent. After applying, avoid rubbing or dabbing skin. This breaks down the fragrance, causing it to wear off more quickly. ",
    type: "Warm & Spicy",
}, {
    name:  "Complexion Rescue Tinted Hydrating Gel Cream" ,
    image:  "https://img.makeupalley.com/1/1/8/1/3549660.JPG", 
    brand: "bareMinerals",
    description: "A clean, cream tinted moisturizer that combines hydrating skincare benefits with naturally radiant, light coverage and SPF 30. Non-comedogenic, Fragrance-free, Cruelty-free and Vegan.",
    kbeauty: false,
    size: "1.18 fl. oz / 35ml",
    price: 37.00,
    category: "Makeup",
    wheretobuy: "Sephora, bareMinerals, Ulta",
    ingredienthighlights: "Hyaluronic Acid, Mineral Electrolytes, Olive-Derived Squalane, and Titanium Dioxide Mineral Sunscreen",
    ...
    target: "All Skin Types",
    instructions: "Either apply with your fingertips by dotting onto your cheeks, forehead, chin and nose, then blend outward or Squeeze a pearl-size amount onto a brush and blend anywhere you want sheer coverage. Continue to layer for medium coverage.",
    type: "foundation",
}
